...
Rounting without rendering a route.

1. How would you explain form validation to someone who has never programmed before?
The requirements setup to accept or deny a value put into a form input.

1. In 1-2 sentences, define end to end testing.
Testing which simulates how an end-user would interact with an app/site's inputs. 
